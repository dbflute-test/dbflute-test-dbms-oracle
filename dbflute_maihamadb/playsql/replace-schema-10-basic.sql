...
create table MEMBER(
    MEMBER_ID NUMBER(9) NOT NULL PRIMARY KEY,
...
create table PURCHASE(
    ...
    PURCHASE_COUNT NUMBER(8) NOT NULL,
...
create table PURCHASE_PAYMENT(
    PURCHASE_PAYMENT_ID NUMBER(16) NOT NULL PRIMARY KEY,
...
create table PRODUCT(
    PRODUCT_ID NUMBER(9) NOT NULL PRIMARY KEY,
