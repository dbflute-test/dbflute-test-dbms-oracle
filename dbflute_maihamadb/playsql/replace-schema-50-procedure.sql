...
create or replace procedure SP_TABLE_NEXT_PARAMETER(
  v_in_varchar_array in /*$nextSchema*/.NEXT_VARCHAR2_TABLE
  , v_out_varchar_array out /*$nextSchema*/.NEXT_VARCHAR2_TABLE
) as
begin
  v_out_varchar_array := v_in_varchar_array;
...
create or replace procedure SP_STRUCT_NEXT_PARAMETER(
  v_in_foo_bean in /*$nextSchema*/.NEXT_FOO_BEAN
  , v_out_foo_bean out /*$nextSchema*/.NEXT_FOO_BEAN
) as
begin
  v_out_foo_bean := v_in_foo_bean;
