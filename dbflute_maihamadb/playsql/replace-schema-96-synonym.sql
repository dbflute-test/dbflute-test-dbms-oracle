...
-- next schema
CREATE SYNONYM SYNONYM_NEXT_SECRET_AUTH for /*$nextSchema*/.NEXT_SCHEMA_SECRET_AUTH;
CREATE SYNONYM SYNONYM_NEXT_SEQUENCE FOR /*$nextSchema*/.SEQ_NEXT_SCHEMA_PRODUCT;
CREATE SYNONYM SYNONYM_NEXT_PROCEDURE FOR /*$nextSchema*/.SP_NEXT_NO_PARAMETER;
CREATE SYNONYM SYNONYM_NEXT_FUNCTION FOR /*$nextSchema*/.FN_NEXT_NO_PARAMETER;
...
--                                                                          Basic Function
--                                                                          ==============
CREATE SYNONYM FN_NEXT_SYNONYM_SAME_NAME FOR /*$nextSchema*/.FN_NEXT_SYNONYM_SAME_NAME;
