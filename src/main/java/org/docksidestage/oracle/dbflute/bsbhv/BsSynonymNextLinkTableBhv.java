...
public abstract class BsSynonymNextLinkTableBhv extends AbstractBehaviorWritable<SynonymNextLinkTable, SynonymNextLinkTableCB> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymNextLinkTable.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">queryUpdate</span>(synonymNextLinkTable, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">queryDelete</span>(synonymNextLinkTable, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of SynonymNextLinkTable. (NotNull)
     ...
     * synonymNextLinkTable.setFoo...(value);
     * synonymNextLinkTable.setBar...(value);
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">varyingInsert</span>(synonymNextLinkTable, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(synonymNextLinkTable, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymNextLinkTable.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(synonymNextLinkTable, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">cb</span>.specify().<span style="color: #CC4747">columnXxxCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// XXX_COUNT = XXX_COUNT + 1</span>
     * });
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymNextLinkTable.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymNextLinkTable, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * SynonymNextLinkTableCB cb = <span style="color: #70226C">new</span> SynonymNextLinkTableCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">synonymNextLinkTableBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymNextLinkTable, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
