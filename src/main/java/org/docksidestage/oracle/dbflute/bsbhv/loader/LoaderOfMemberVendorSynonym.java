...
public class LoaderOfMemberVendorSynonym {
     ...
     * <pre>
     * <span style="color: #0000C0">memberVendorSynonymBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">memberVendorSynonymList</span>, <span style="color: #553000">synonymLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">synonymLoader</span>.<span style="color: #CC4747">loadSynonymMemberLogin</span>(<span style="color: #553000">loginCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (MemberVendorSynonym memberVendorSynonym : <span style="color: #553000">memberVendorSynonymList</span>) {
