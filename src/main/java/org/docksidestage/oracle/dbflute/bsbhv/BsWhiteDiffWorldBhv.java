...
public abstract class BsWhiteDiffWorldBhv extends AbstractBehaviorWritable<WhiteDiffWorld, WhiteDiffWorldCB> {
     ...
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteDiffWorld, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteDiffWorld, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteDiffWorld. (NotNull)
     ...
     * whiteDiffWorld.setFoo...(value);
     * whiteDiffWorld.setBar...(value);
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteDiffWorld, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteDiffWorld, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteDiffWorld.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDiffWorld, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteDiffWorldCB cb = <span style="color: #70226C">new</span> WhiteDiffWorldCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteDiffWorldBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteDiffWorld, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
