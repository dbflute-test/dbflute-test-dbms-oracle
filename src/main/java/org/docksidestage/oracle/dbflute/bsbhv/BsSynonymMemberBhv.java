...
public abstract class BsSynonymMemberBhv extends AbstractBehaviorWritable<SynonymMember, SynonymMemberCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public SynonymMemberDbm asDBMeta() { return SynonymMemberDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "SYNONYM_MEMBER"; }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymMember.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">queryUpdate</span>(synonymMember, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">queryDelete</span>(synonymMember, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of SynonymMember. (NotNull)
     ...
     * synonymMember.setFoo...(value);
     * synonymMember.setBar...(value);
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">varyingInsert</span>(synonymMember, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(synonymMember, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymMember.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(synonymMember, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">cb</span>.specify().<span style="color: #CC4747">columnXxxCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// XXX_COUNT = XXX_COUNT + 1</span>
     * });
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymMember.setVersionNo(value);</span>
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymMember, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * SynonymMemberCB cb = <span style="color: #70226C">new</span> SynonymMemberCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymMember, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
