...
public abstract class BsWhiteSameNameRefRefBhv extends AbstractBehaviorWritable<WhiteSameNameRefRef, WhiteSameNameRefRefCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteSameNameRefRefDbm asDBMeta() { return WhiteSameNameRefRefDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "WHITE_SAME_NAME_REF_REF"; }
     ...
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteSameNameRefRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteSameNameRefRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSameNameRefRef. (NotNull)
     ...
     * whiteSameNameRefRef.setFoo...(value);
     * whiteSameNameRefRef.setBar...(value);
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteSameNameRefRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteSameNameRefRef, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteSameNameRefRef.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSameNameRefRef, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteSameNameRefRefCB cb = <span style="color: #70226C">new</span> WhiteSameNameRefRefCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteSameNameRefRefBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSameNameRefRef, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
