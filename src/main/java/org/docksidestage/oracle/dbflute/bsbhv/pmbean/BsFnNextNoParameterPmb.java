 ...
 * This is related to "<span style="color: #AD4747">NEWURAYASUDB.FN_NEXT_NO_PARAMETER</span>".
 * @author oracleman
 */
public class BsFnNextNoParameterPmb implements ProcedurePmb, FetchBean {
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "NEWURAYASUDB.FN_NEXT_NO_PARAMETER"; }
