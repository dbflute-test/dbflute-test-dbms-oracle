...
public class BsSpStructBasicParameterPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of VInFooBean: {MAIHAMADB.FOO_BEAN as In}. */
    protected FooBean _vInFooBean;

    /** The parameter of VOutFooBean: {MAIHAMADB.FOO_BEAN as Out}. */
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "SP_STRUCT_BASIC_PARAMETER"; }
    ...
    //                                                                            ========
    /**
     * [get] VInFooBean: {MAIHAMADB.FOO_BEAN as In} <br>
    ...
    /**
     * [set] VInFooBean: {MAIHAMADB.FOO_BEAN as In} <br>
    ...
    /**
     * [get] VOutFooBean: {MAIHAMADB.FOO_BEAN as Out} <br>
    ...
    /**
     * [set] VOutFooBean: {MAIHAMADB.FOO_BEAN as Out} <br>
