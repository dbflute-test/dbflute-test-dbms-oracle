...
public abstract class BsSynonymProductBhv extends AbstractBehaviorWritable<SynonymProduct, SynonymProductCB> {
     ...
     * <span style="color: #0000C0">synonymProductBhv</span>.<span style="color: #CC4747">varyingInsert</span>(synonymProduct, option);
     * ... = synonymProduct.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param synonymProduct The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">synonymProductBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(synonymProduct, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//synonymProduct.setVersionNo(value);</span>
     * UpdateOption&lt;SynonymProductCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;SynonymProductCB&gt;();
     * option.self(new SpecifyQuery&lt;SynonymProductCB&gt;() {
     *     public void specify(SynonymProductCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">synonymProductBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(synonymProduct, option);
     * </pre>
     * @param synonymProduct The entity of update. (NotNull, PrimaryKeyNotNull)
     * @param opLambda The callback for option of update for varying requests. (NotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     ...
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">synonymProductBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymProduct, cb, option);
     * </pre>
