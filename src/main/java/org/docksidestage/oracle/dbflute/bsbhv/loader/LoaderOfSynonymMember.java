...
public class LoaderOfSynonymMember {
     ...
     * <pre>
     * <span style="color: #0000C0">synonymMemberBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">synonymMemberList</span>, <span style="color: #553000">memberLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (SynonymMember synonymMember : <span style="color: #553000">synonymMemberList</span>) {
