 ...
 * This is related to "<span style="color: #AD4747">NEWURAYASUDB.NEXT_PKG.SP_PKG_IN_OUT_PARAMETER</span>".
 * @author oracleman
 */
public class BsNextPkgSpPkgInOutParameterPmb implements ProcedurePmb, FetchBean {
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "NEWURAYASUDB.NEXT_PKG.SP_PKG_IN_OUT_PARAMETER"; }
