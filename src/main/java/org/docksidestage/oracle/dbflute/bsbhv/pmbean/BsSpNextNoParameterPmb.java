 ...
 * This is related to "<span style="color: #AD4747">NEWURAYASUDB.SP_NEXT_NO_PARAMETER</span>".
 * @author oracleman
 */
public class BsSpNextNoParameterPmb implements ProcedurePmb, FetchBean {
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "NEWURAYASUDB.SP_NEXT_NO_PARAMETER"; }
