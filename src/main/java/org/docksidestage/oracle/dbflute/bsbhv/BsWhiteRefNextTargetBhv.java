...
public abstract class BsWhiteRefNextTargetBhv extends AbstractBehaviorWritable<WhiteRefNextTarget, WhiteRefNextTargetCB> {
     ...
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteRefNextTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteRefNextTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteRefNextTarget. (NotNull)
     ...
     * whiteRefNextTarget.setFoo...(value);
     * whiteRefNextTarget.setBar...(value);
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteRefNextTarget, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteRefNextTarget, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteRefNextTarget.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteRefNextTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteRefNextTargetCB cb = <span style="color: #70226C">new</span> WhiteRefNextTargetCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteRefNextTargetBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteRefNextTarget, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
