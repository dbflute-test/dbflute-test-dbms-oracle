...
public abstract class BsSynonymNextSecretAuthBhv extends AbstractBehaviorWritable<SynonymNextSecretAuth, SynonymNextSecretAuthCB> {
     ...
     * <span style="color: #0000C0">synonymNextSecretAuthBhv</span>.<span style="color: #CC4747">varyingInsert</span>(synonymNextSecretAuth, option);
     * ... = synonymNextSecretAuth.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param synonymNextSecretAuth The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">synonymNextSecretAuthBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(synonymNextSecretAuth, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * SynonymNextSecretAuthCB cb = new SynonymNextSecretAuthCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;SynonymNextSecretAuthCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;SynonymNextSecretAuthCB&gt;();
     * option.self(new SpecifyQuery&lt;SynonymNextSecretAuthCB&gt;() {
     *     public void specify(SynonymNextSecretAuthCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">synonymNextSecretAuthBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymNextSecretAuth, cb, option);
     * </pre>
