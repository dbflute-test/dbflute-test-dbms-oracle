...
public abstract class BsWithdrawalReasonBhv extends AbstractBehaviorWritable<WithdrawalReason, WithdrawalReasonCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">loadSynonymMemberWithdrawal</span>(<span style="color: #553000">withdrawalReasonList</span>, <span style="color: #553000">withdrawalCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">withdrawalCB</span>.setupSelect...
     *     <span style="color: #553000">withdrawalCB</span>.query().set...
     *     <span style="color: #553000">withdrawalCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawal(List<WithdrawalReason> withdrawalReasonList, ConditionBeanSetupper<SynonymMemberWithdrawalCB> refCBLambda) {
        xassLRArg(withdrawalReasonList, refCBLambda);
        return doLoadSynonymMemberWithdrawal(withdrawalReasonList, new LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal>().xinit(refCBLambda));
    }
     ...
     * SYNONYM_MEMBER_WITHDRAWAL by WITHDRAWAL_REASON_CODE, named 'synonymMemberWithdrawalList'.
     * <pre>
     * <span style="color: #0000C0">withdrawalReasonBhv</span>.<span style="color: #CC4747">loadSynonymMemberWithdrawal</span>(<span style="color: #553000">withdrawalReason</span>, <span style="color: #553000">withdrawalCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">withdrawalCB</span>.setupSelect...
     *     <span style="color: #553000">withdrawalCB</span>.query().set...
     *     <span style="color: #553000">withdrawalCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">withdrawalReason</span>.<span style="color: #CC4747">getSynonymMemberWithdrawalList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawal(WithdrawalReason withdrawalReason, ConditionBeanSetupper<SynonymMemberWithdrawalCB> refCBLambda) {
        xassLRArg(withdrawalReason, refCBLambda);
        return doLoadSynonymMemberWithdrawal(xnewLRLs(withdrawalReason), new LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawal(WithdrawalReason withdrawalReason, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReason, loadReferrerOption);
        return loadSynonymMemberWithdrawal(xnewLRLs(withdrawalReason), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<SynonymMemberWithdrawal> loadSynonymMemberWithdrawal(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> loadReferrerOption) {
        xassLRArg(withdrawalReasonList, loadReferrerOption);
        if (withdrawalReasonList.isEmpty()) { return (NestedReferrerListGateway<SynonymMemberWithdrawal>)EMPTY_NREF_LGWAY; }
        return doLoadSynonymMemberWithdrawal(withdrawalReasonList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<SynonymMemberWithdrawal> doLoadSynonymMemberWithdrawal(List<WithdrawalReason> withdrawalReasonList, LoadReferrerOption<SynonymMemberWithdrawalCB, SynonymMemberWithdrawal> option) {
