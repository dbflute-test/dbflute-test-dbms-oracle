...
public abstract class BsWhiteTargetBhv extends AbstractBehaviorWritable<WhiteTarget, WhiteTargetCB> {
     ...
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">queryDelete</span>(whiteTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteTarget. (NotNull)
     ...
     * whiteTarget.setFoo...(value);
     * whiteTarget.setBar...(value);
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteTarget, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteTarget, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteTarget.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteTarget, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteTargetCB cb = <span style="color: #70226C">new</span> WhiteTargetCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteTarget, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
