...
public class LoaderOfVendorLargeName90123456Ref {
    ...
    public LoaderOfVendorLargeName901234567890 pulloutVendorLargeName901234567890() {
        if (_foreignVendorLargeName901234567890Loader == null)
        { _foreignVendorLargeName901234567890Loader = new LoaderOfVendorLargeName901234567890().ready(myBhv().pulloutVendorLargeName901234567890(_selectedList), _selector); }
