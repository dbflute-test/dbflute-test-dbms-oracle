...
public class BsOptionMemberPmb implements ListHandlingPmb<MemberBhv, OptionMember>, EntityHandlingPmb<MemberBhv, OptionMember>, FetchBean {
    ...
    /** The parameter of displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(8)}. */
    ...
    /**
     * [get] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(8)} <br>
    ...
    /**
     * [set] displayOrder:ref(MemberStatus) :: refers to DISPLAY_ORDER: {UQ, NotNull, NUMBER(8)} <br>
