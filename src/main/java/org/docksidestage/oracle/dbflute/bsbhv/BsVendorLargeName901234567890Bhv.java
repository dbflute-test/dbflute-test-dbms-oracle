...
public abstract class BsVendorLargeName901234567890Bhv extends AbstractBehaviorWritable<VendorLargeName901234567890, VendorLargeName901234567890CB> {
     ...
     * <span style="color: #0000C0">vendorLargeName901234567890Bhv</span>.<span style="color: #CC4747">varyingInsert</span>(vendorLargeName901234567890, option);
     * ... = vendorLargeName901234567890.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorLargeName901234567890 The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">vendorLargeName901234567890Bhv</span>.<span style="color: #CC4747">varyingUpdate</span>(vendorLargeName901234567890, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * VendorLargeName901234567890CB cb = new VendorLargeName901234567890CB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;VendorLargeName901234567890CB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;VendorLargeName901234567890CB&gt;();
     * option.self(new SpecifyQuery&lt;VendorLargeName901234567890CB&gt;() {
     *     public void specify(VendorLargeName901234567890CB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">vendorLargeName901234567890Bhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorLargeName901234567890, cb, option);
     * </pre>
