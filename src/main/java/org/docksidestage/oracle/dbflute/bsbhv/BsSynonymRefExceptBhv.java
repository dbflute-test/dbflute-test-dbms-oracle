...
public abstract class BsSynonymRefExceptBhv extends AbstractBehaviorWritable<SynonymRefExcept, SynonymRefExceptCB> {
     ...
     * <span style="color: #0000C0">synonymRefExceptBhv</span>.<span style="color: #CC4747">varyingInsert</span>(synonymRefExcept, option);
     * ... = synonymRefExcept.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param synonymRefExcept The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">synonymRefExceptBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(synonymRefExcept, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * SynonymRefExceptCB cb = new SynonymRefExceptCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;SynonymRefExceptCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;SynonymRefExceptCB&gt;();
     * option.self(new SpecifyQuery&lt;SynonymRefExceptCB&gt;() {
     *     public void specify(SynonymRefExceptCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">synonymRefExceptBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(synonymRefExcept, cb, option);
     * </pre>
