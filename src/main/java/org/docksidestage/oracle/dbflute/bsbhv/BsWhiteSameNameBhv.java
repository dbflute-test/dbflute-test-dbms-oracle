...
public abstract class BsWhiteSameNameBhv extends AbstractBehaviorWritable<WhiteSameName, WhiteSameNameCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteSameNameDbm asDBMeta() { return WhiteSameNameDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "WHITE_SAME_NAME"; }
     ...
     * });
     * <span style="color: #70226C">for</span> (WhiteSameName <span style="color: #553000">whiteSameName</span> : <span style="color: #553000">whiteSameNameList</span>) {
     *     ... = <span style="color: #553000">whiteSameName</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSameName. (NotNull)
     ...
     * <span style="color: #70226C">for</span> (WhiteSameName whiteSameName : <span style="color: #553000">whiteSameNameList</span>) {
     *     ... = whiteSameName.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteSameName. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteSameName whiteSameName : <span style="color: #553000">page</span>) {
     *     ... = whiteSameName.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSameName. (NotNull)
     ...
     * <pre>
     * WhiteSameName whiteSameName = <span style="color: #70226C">new</span> WhiteSameName();
     ...
     * <span style="color: #0000C0">whiteSameNameBhv</span>.<span style="color: #CC4747">queryUpdate</span>(whiteSameName, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * whiteSameName.setFoo...(value);
     * whiteSameName.setBar...(value);
     * <span style="color: #0000C0">whiteSameNameBhv</span>.<span style="color: #CC4747">varyingInsert</span>(whiteSameName, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteSameNameBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(whiteSameName, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteSameName> whiteSameNameList, WritableOptionCall<WhiteSameNameCB, InsertOption<WhiteSameNameCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteSameName> whiteSameNameList, WritableOptionCall<WhiteSameNameCB, UpdateOption<WhiteSameNameCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteSameName> whiteSameNameList, WritableOptionCall<WhiteSameNameCB, DeleteOption<WhiteSameNameCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteSameName, WhiteSameNameCB> manyArgLambda, WritableOptionCall<WhiteSameNameCB, InsertOption<WhiteSameNameCB>> opLambda) {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//whiteSameName.setVersionNo(value);</span>
     * <span style="color: #0000C0">whiteSameNameBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSameName, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * WhiteSameNameCB cb = <span style="color: #70226C">new</span> WhiteSameNameCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">whiteSameNameBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(whiteSameName, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
