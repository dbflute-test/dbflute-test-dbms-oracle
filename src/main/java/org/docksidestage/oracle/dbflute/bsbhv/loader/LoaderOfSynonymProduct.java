...
public class LoaderOfSynonymProduct {
    ...
    public LoaderOfSynonymProductStatus pulloutSynonymProductStatus() {
        if (_foreignSynonymProductStatusLoader == null)
        { _foreignSynonymProductStatusLoader = new LoaderOfSynonymProductStatus().ready(myBhv().pulloutSynonymProductStatus(_selectedList), _selector); }
