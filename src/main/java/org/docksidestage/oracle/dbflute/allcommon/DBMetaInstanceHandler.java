...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_VENDOR_SYNONYM", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberVendorSynonymDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("PURCHASE_PAYMENT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("REGION", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_MEMBER_PURCHASE", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SummaryMemberPurchaseDbm");
        tmpMap.put("SUMMARY_PRODUCT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("SYNONYM_EXCEPT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymExceptDbm");
        tmpMap.put("SYNONYM_MEMBER", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymMemberDbm");
        tmpMap.put("SYNONYM_MEMBER_LOGIN", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymMemberLoginDbm");
        tmpMap.put("SYNONYM_MEMBER_WITHDRAWAL", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymMemberWithdrawalDbm");
        tmpMap.put("SYNONYM_NEXT_LINK_SECRET", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymNextLinkSecretDbm");
        tmpMap.put("SYNONYM_NEXT_LINK_SYNONYM", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymNextLinkSynonymDbm");
        tmpMap.put("SYNONYM_NEXT_LINK_TABLE", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymNextLinkTableDbm");
        tmpMap.put("SYNONYM_NEXT_SAME_NAME_FK", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymNextSameNameFkDbm");
        tmpMap.put("SYNONYM_NEXT_SECRET_AUTH", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymNextSecretAuthDbm");
        tmpMap.put("SYNONYM_PRODUCT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymProductDbm");
        tmpMap.put("SYNONYM_PRODUCT_STATUS", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymProductStatusDbm");
        tmpMap.put("SYNONYM_REF_EXCEPT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.SynonymRefExceptDbm");
        tmpMap.put("VENDOR_$_DOLLAR", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.Vendor$DollarDbm");
        tmpMap.put("VENDOR_CHECK", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("VENDOR_LARGE_DATA", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorLargeDataDbm");
        tmpMap.put("VENDOR_LARGE_DATA_REF", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorLargeDataRefDbm");
        tmpMap.put("VENDOR_LARGE_NAME_901234567890", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorLargeName901234567890Dbm");
        tmpMap.put("VENDOR_LARGE_NAME_90123456_REF", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorLargeName90123456RefDbm");
        tmpMap.put("VENDOR_SYNONYM_MEMBER", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.VendorSynonymMemberDbm");
        tmpMap.put("WHITE_DIFF_WORLD", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteDiffWorldDbm");
        tmpMap.put("WHITE_REF_NEXT_EXCEPT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteRefNextExceptDbm");
        tmpMap.put("WHITE_REF_NEXT_TARGET", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteRefNextTargetDbm");
        tmpMap.put("WHITE_REF_TARGET", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteRefTargetDbm");
        tmpMap.put("WHITE_SAME_NAME", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteSameNameDbm");
        tmpMap.put("WHITE_SAME_NAME_REF_REF", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteSameNameRefRefDbm");
        tmpMap.put("WHITE_TARGET", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteTargetDbm");
        tmpMap.put("WHITE_UQ_FK", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteUqFkDbm");
        tmpMap.put("WHITE_UQ_FK_REF", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteUqFkRefDbm");
        tmpMap.put("WHITE_UQ_FK_REF_NEST", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteUqFkRefNestDbm");
        tmpMap.put("WHITE_UQ_FK_WITHOUT_PK", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteUqFkWithoutPkDbm");
        tmpMap.put("WHITE_UQ_FK_WITHOUT_PK_REF", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WhiteUqFkWithoutPkRefDbm");
        tmpMap.put("WITHDRAWAL_REASON", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
        tmpMap.put("NEXT_SCHEMA_PRODUCT", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.NextSchemaProductDbm");
        tmpMap.put("NEXT_SCHEMA_PRODUCT_STATUS", "org.docksidestage.oracle.dbflute.bsentity.dbmeta.NextSchemaProductStatusDbm");
