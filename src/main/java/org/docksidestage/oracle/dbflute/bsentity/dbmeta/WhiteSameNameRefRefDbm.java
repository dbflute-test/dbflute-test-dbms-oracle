...
public class WhiteSameNameRefRefDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((WhiteSameNameRefRef)et).getRefRefDate(), (et, vl) -> ((WhiteSameNameRefRef)et).setRefRefDate(ctld(vl)), "refRefDate");
    }
    ...
    protected final String _tableDispName = "WHITE_SAME_NAME_REF_REF";
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRefRefId = cci("REF_REF_ID", "REF_REF_ID", null, null, Long.class, "refRefId", null, true, false, true, "NUMBER", 16, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnRefRefName = cci("REF_REF_NAME", "REF_REF_NAME", null, null, String.class, "refRefName", null, false, false, true, "VARCHAR2", 100, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnRefRefDate = cci("REF_REF_DATE", "REF_REF_DATE", null, null, java.time.LocalDate.class, "refRefDate", null, false, false, true, "DATE", 7, 0, null, null, false, null, null, null, null, null, false);
