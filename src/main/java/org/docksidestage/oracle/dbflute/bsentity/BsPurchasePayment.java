...
public abstract class BsPurchasePayment extends AbstractEntity implements DomainEntity {
    ...
    //                                                                            ========
    /**
     * [get] PURCHASE_PAYMENT_ID: {PK, NotNull, NUMBER(16)} <br>
    ...
    /**
     * [set] PURCHASE_PAYMENT_ID: {PK, NotNull, NUMBER(16)} <br>
    ...
    /**
     * [get] PURCHASE_ID: {NotNull, NUMBER(16), FK to PURCHASE} <br>
    ...
    /**
     * [set] PURCHASE_ID: {NotNull, NUMBER(16), FK to PURCHASE} <br>
    ...
    /**
     * [get] PAYMENT_AMOUNT: {NotNull, NUMBER(10, 2)} <br>
    ...
    /**
     * [set] PAYMENT_AMOUNT: {NotNull, NUMBER(10, 2)} <br>
    ...
    /**
     * [get] PAYMENT_DATETIME: {IX+, NotNull, TIMESTAMP(3)(11, 3)} <br>
    ...
    /**
     * [set] PAYMENT_DATETIME: {IX+, NotNull, TIMESTAMP(3)(11, 3)} <br>
