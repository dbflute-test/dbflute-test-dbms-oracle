...
public class NextSchemaProductDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignNextSchemaProductStatus() {
        ...
        return cfi("FK_NEXT_SCHEMA_PRODUCT", "nextSchemaProductStatus", this, NextSchemaProductStatusDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "nextSchemaProductList");
    }
