...
public class NextSchemaProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "隣の商品ID", Long.class, "productId", null, true, false, true, "NUMBER", 16, 0, null, null, false, null, "隣のベーシックなPK", null, null, null, false);
    protected final ColumnInfo _columnProductName = cci("PRODUCT_NAME", "PRODUCT_NAME", null, "隣の商品名称", String.class, "productName", null, false, false, true, "VARCHAR2", 50, 0, null, null, false, null, "隣のベーシックなName", null, null, null, false);
    ...
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, null, String.class, "productStatusCode", null, false, false, true, "CHAR", 3, 0, null, null, false, null, null, "nextSchemaProductStatus", null, null, false);
