...
public class VendorLargeName901234567890Dbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((VendorLargeName901234567890)et).getVendorLargeName901234567Id(), (et, vl) -> ((VendorLargeName901234567890)et).setVendorLargeName901234567Id(ctl(vl)), "vendorLargeName901234567Id");
        setupEpg(_epgMap, et -> ((VendorLargeName901234567890)et).getVendorLargeName9012345Name(), (et, vl) -> ((VendorLargeName901234567890)et).setVendorLargeName9012345Name((String)vl), "vendorLargeName9012345Name");
    }
    ...
    protected final String _tableDispName = "VENDOR_LARGE_NAME_901234567890";
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnVendorLargeName901234567Id = cci("VENDOR_LARGE_NAME_901234567_ID", "VENDOR_LARGE_NAME_901234567_ID", null, null, Long.class, "vendorLargeName901234567Id", null, true, false, true, "NUMBER", 16, 0, null, null, false, null, null, null, "vendorLargeName90123456RefList", null, false);
    protected final ColumnInfo _columnVendorLargeName9012345Name = cci("VENDOR_LARGE_NAME_9012345_NAME", "VENDOR_LARGE_NAME_9012345_NAME", null, null, String.class, "vendorLargeName9012345Name", null, false, false, true, "VARCHAR2", 32, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.oracle.dbflute.exentity.VendorLargeName901234567890"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.oracle.dbflute.cbean.VendorLargeName901234567890CB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.oracle.dbflute.exbhv.VendorLargeName901234567890Bhv"; }
