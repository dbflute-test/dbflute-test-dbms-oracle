...
public class RegionDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((Region)et).getRegionId(), (et, vl) -> {
            ...
            if (cls != null) {
                ...
                ((Region)et).mynativeMappingRegionId(ctn(vl, java.math.BigDecimal.class));
            }
        }, "regionId");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, java.math.BigDecimal.class, "regionId", null, true, false, true, "NUMBER", 22, 0, null, false, null, null, null, "memberAddressList", CDef.DefMeta.Region, false);
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, null, String.class, "regionName", null, false, false, true, "VARCHAR2", 50, 0, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.oracle.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.oracle.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.oracle.dbflute.exbhv.RegionBhv"; }
