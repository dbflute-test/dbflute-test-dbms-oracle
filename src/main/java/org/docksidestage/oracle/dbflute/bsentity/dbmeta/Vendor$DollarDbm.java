...
public class Vendor$DollarDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((Vendor$Dollar)et).getVendor$DollarId(), (et, vl) -> ((Vendor$Dollar)et).setVendor$DollarId(ctl(vl)), "vendor$DollarId");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnVendor$DollarId = cci("VENDOR_$_DOLLAR_ID", "VENDOR_$_DOLLAR_ID", null, null, Long.class, "vendor$DollarId", null, true, false, true, "NUMBER", 16, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnVendor$DollarName = cci("VENDOR_$_DOLLAR_NAME", "VENDOR_$_DOLLAR_NAME", null, null, String.class, "vendor$DollarName", null, false, false, true, "VARCHAR2", 32, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.oracle.dbflute.exentity.Vendor$Dollar"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.oracle.dbflute.cbean.Vendor$DollarCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.oracle.dbflute.exbhv.Vendor$DollarBhv"; }
