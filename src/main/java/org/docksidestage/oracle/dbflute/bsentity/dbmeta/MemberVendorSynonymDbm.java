...
public class MemberVendorSynonymDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", Integer.class, "memberId", null, true, false, true, "NUMBER", 9, 0, null, false, null, "連番", null, "synonymMemberLoginList", null);
    ...
    public ForeignInfo foreignMemberStatus() {
        ...
        return cfi("FK_MEMBER_MEMBER_STATUS", "memberStatus", this, MemberStatusDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "memberVendorSynonymList");
    }
    /**
    ...
    public ForeignInfo foreignSynonymMemberWithdrawalAsOne() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER_SYNONYM1", "synonymMemberWithdrawalAsOne", this, SynonymMemberWithdrawalDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, true, false, true, false, null, null, false, "memberVendorSynonym");
    }
