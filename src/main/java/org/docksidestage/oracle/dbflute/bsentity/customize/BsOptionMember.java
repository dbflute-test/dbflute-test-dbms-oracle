...
public abstract class BsOptionMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.oracle.dbflute.bsentity.customize.dbmeta.OptionMemberDbm.getInstance();
    }
    ...
    /**
     * [get] STATUS_DISPLAY_ORDER: {NUMBER(8)} <br>
    ...
    /**
     * [set] STATUS_DISPLAY_ORDER: {NUMBER(8)} <br>
     ...
     * @param dummyFlg The value of the column 'DUMMY_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void mynativeMappingDummyFlg(java.math.BigDecimal dummyFlg) {
