...
public class SpResultSetParameterWithCurMemberStatusDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SpResultSetParameterWithCurMemberStatus)et).getMemberStatusCode(), (et, vl) -> ((SpResultSetParameterWithCurMemberStatus)et).setMemberStatusCode((String)vl), "memberStatusCode");
        setupEpg(_epgMap, et -> ((SpResultSetParameterWithCurMemberStatus)et).getMemberStatusName(), (et, vl) -> ((SpResultSetParameterWithCurMemberStatus)et).setMemberStatusName((String)vl), "memberStatusName");
        setupEpg(_epgMap, et -> ((SpResultSetParameterWithCurMemberStatus)et).getDescription(), (et, vl) -> ((SpResultSetParameterWithCurMemberStatus)et).setDescription((String)vl), "description");
        setupEpg(_epgMap, et -> ((SpResultSetParameterWithCurMemberStatus)et).getDisplayOrder(), (et, vl) -> ((SpResultSetParameterWithCurMemberStatus)et).setDisplayOrder(cti(vl)), "displayOrder");
    }
    ...
    protected final String _tableDispName = "SpResultSetParameterWithCurMemberStatus";
    ...
    protected final ColumnInfo _columnDescription = cci("DESCRIPTION", "DESCRIPTION", null, null, String.class, "description", null, false, false, false, "VARCHAR2", 200, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnDisplayOrder = cci("DISPLAY_ORDER", "DISPLAY_ORDER", null, null, Integer.class, "displayOrder", null, false, false, false, "NUMBER", 8, 0, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.oracle.dbflute.exentity.customize.SpResultSetParameterWithCurMemberStatus"; }
