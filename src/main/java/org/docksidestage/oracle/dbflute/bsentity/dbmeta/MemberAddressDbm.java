...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnValidBeginDate = cci("VALID_BEGIN_DATE", "VALID_BEGIN_DATE", null, null, java.time.LocalDate.class, "validBeginDate", null, false, false, true, "DATE", 7, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnValidEndDate = cci("VALID_END_DATE", "VALID_END_DATE", null, null, java.time.LocalDate.class, "validEndDate", null, false, false, true, "DATE", 7, 0, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, java.math.BigDecimal.class, "regionId", null, false, false, true, "NUMBER", 22, 0, null, false, null, null, "region", null, CDef.DefMeta.Region);
