...
public class PurchaseMaxPriceMemberDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((PurchaseMaxPriceMember)et).getPurchaseMaxPrice(), (et, vl) -> ((PurchaseMaxPriceMember)et).setPurchaseMaxPrice(ctb(vl)), "purchaseMaxPrice");
        ...
        setupEpg(_epgMap, et -> ((PurchaseMaxPriceMember)et).getRn(), (et, vl) -> ((PurchaseMaxPriceMember)et).setRn(ctb(vl)), "rn");
    }
    ...
    protected final ColumnInfo _columnPurchaseMaxPrice = cci("PURCHASE_MAX_PRICE", "PURCHASE_MAX_PRICE", null, null, java.math.BigDecimal.class, "purchaseMaxPrice", null, false, false, false, "NUMBER", 39, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnRn = cci("RN", "RN", null, null, java.math.BigDecimal.class, "rn", null, false, false, false, "NUMBER", 39, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.oracle.dbflute.exentity.customize.PurchaseMaxPriceMember"; }
