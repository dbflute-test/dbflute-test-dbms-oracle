...
public class SynonymNextLinkSynonymDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SynonymNextLinkSynonym)et).getRegisterDatetime(), (et, vl) -> ((SynonymNextLinkSynonym)et).setRegisterDatetime(ctldt(vl)), "registerDatetime");
        ...
        setupEpg(_epgMap, et -> ((SynonymNextLinkSynonym)et).getUpdateDatetime(), (et, vl) -> ((SynonymNextLinkSynonym)et).setUpdateDatetime(ctldt(vl)), "updateDatetime");
    ...
    protected final String _tableDispName = "SYNONYM_NEXT_LINK_SYNONYM";
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Long.class, "productId", null, true, false, true, "NUMBER", 16, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnProductName = cci("PRODUCT_NAME", "PRODUCT_NAME", null, null, String.class, "productName", null, false, false, true, "VARCHAR2", 50, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnProductHandleCode = cci("PRODUCT_HANDLE_CODE", "PRODUCT_HANDLE_CODE", null, null, String.class, "productHandleCode", null, false, false, true, "VARCHAR2", 100, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnRegisterDatetime = cci("REGISTER_DATETIME", "REGISTER_DATETIME", null, null, java.time.LocalDateTime.class, "registerDatetime", null, false, false, true, "TIMESTAMP", null, null, null, null, true, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnUpdateDatetime = cci("UPDATE_DATETIME", "UPDATE_DATETIME", null, null, java.time.LocalDateTime.class, "updateDatetime", null, false, false, true, "TIMESTAMP", null, null, null, null, true, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnVersionNo = cci("VERSION_NO", "VERSION_NO", null, null, java.math.BigDecimal.class, "versionNo", null, false, false, true, "NUMBER", 38, 0, null, null, false, OptimisticLockType.VERSION_NO, null, null, null, null, false);
