...
public abstract class BsSynonymNextLinkTable extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * [get] REGISTER_DATETIME: {NotNull, TIMESTAMP} <br>
    ...
    /**
     * [set] REGISTER_DATETIME: {NotNull, TIMESTAMP} <br>
    ...
    /**
     * [get] UPDATE_DATETIME: {NotNull, TIMESTAMP} <br>
    ...
    /**
     * [set] UPDATE_DATETIME: {NotNull, TIMESTAMP} <br>
