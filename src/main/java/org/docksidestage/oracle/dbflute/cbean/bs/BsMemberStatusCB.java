...
public class BsMemberStatusCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MemberStatusCB acceptUniqueOfDisplayOrder(Integer displayOrder) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberStatusCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(synonymCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     synonymCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     synonymCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, MemberVendorSynonym.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
         ...
         *     memberCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     memberCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, SynonymMember.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
         ...
         *     memberCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     memberCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, VendorSynonymMember.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
