...
public abstract class AbstractBsSynonymNextLinkSynonymCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, SynonymNextLinkSynonymCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, SynonymNextLinkSynonymCB.class);
    }
    ...
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, SynonymNextLinkSynonymCB.class);
    }
    ...
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, SynonymNextLinkSynonymCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, SynonymNextLinkSynonymCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;SynonymNextLinkSynonymCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymNextLinkSynonymCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, SynonymNextLinkSynonymCB.class);
    }
     ...
     */
    public void myselfExists(SubQuery<SynonymNextLinkSynonymCB> subCBLambda) {
