...
public class BsSynonymProductCQ extends AbstractBsSynonymProductCQ {
    ...
    public SynonymProductStatusCQ querySynonymProductStatus() {
        return xdfgetConditionQuerySynonymProductStatus();
    }
    public SynonymProductStatusCQ xdfgetConditionQuerySynonymProductStatus() {
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, SynonymProductCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(SynonymProductCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, SynonymProductCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(SynonymProductCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, SynonymProductCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, SynonymProductCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(SynonymProductCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, SynonymProductCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
