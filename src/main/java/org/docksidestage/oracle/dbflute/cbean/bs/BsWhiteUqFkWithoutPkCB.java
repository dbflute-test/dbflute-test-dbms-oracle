...
public class BsWhiteUqFkWithoutPkCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteUqFkWithoutPkCQ> {
         ...
         */
        public HpSDRFunction<WhiteUqFkWithoutPkRefCB, WhiteUqFkWithoutPkCQ> derivedWhiteUqFkWithoutPkRef() {
     ...
     */
    public HpColQyOperand<WhiteUqFkWithoutPkCB> columnQuery(final SpecifyQuery<WhiteUqFkWithoutPkCB> colCBLambda) {
