...
public class BsVendorLargeName901234567890CB extends AbstractConditionBean {
    ...
    public VendorLargeName901234567890CQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected VendorLargeName901234567890CQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<VendorLargeName901234567890CB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorLargeName901234567890CB> unionCBLambda) {
        final VendorLargeName901234567890CB cb = new VendorLargeName901234567890CB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorLargeName901234567890CQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVendorLargeName9012345Name() { return doColumn("VENDOR_LARGE_NAME_9012345_NAME"); }
         ...
         * }, VendorLargeName90123456Ref.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<VendorLargeName90123456RefCB, VendorLargeName901234567890CQ> derivedVendorLargeName90123456Ref() {
            assertDerived("vendorLargeName90123456RefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorLargeName90123456RefCB> sq, VendorLargeName901234567890CQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<VendorLargeName901234567890CB, VendorLargeName901234567890CQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorLargeName901234567890CB> sq, VendorLargeName901234567890CQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;VendorLargeName901234567890CB&gt;() {
     ...
     */
    public HpColQyOperand<VendorLargeName901234567890CB> columnQuery(final SpecifyQuery<VendorLargeName901234567890CB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;VendorLargeName901234567890CB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<VendorLargeName901234567890CB> orCBLambda) {
        xorSQ((VendorLargeName901234567890CB)this, orCBLambda);
    }
     ...
     *     public void query(VendorLargeName901234567890CB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorLargeName901234567890CB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorLargeName901234567890CB> andCBLambda) {
        xorSQAP((VendorLargeName901234567890CB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return VendorLargeName901234567890CB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return VendorLargeName901234567890CQ.class.getName(); }
