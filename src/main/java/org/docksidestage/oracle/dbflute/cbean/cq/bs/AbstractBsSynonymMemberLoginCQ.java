...
public abstract class AbstractBsSynonymMemberLoginCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, SynonymMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, SynonymMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, SynonymMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, SynonymMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, SynonymMemberLoginCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;SynonymMemberLoginCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymMemberLoginCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, SynonymMemberLoginCB.class);
    }
     ...
     */
    public void myselfExists(SubQuery<SynonymMemberLoginCB> subCBLambda) {
