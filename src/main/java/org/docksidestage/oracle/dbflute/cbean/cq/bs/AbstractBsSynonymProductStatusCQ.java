...
public abstract class AbstractBsSynonymProductStatusCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<SynonymProductStatusCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, SynonymProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymProductStatusCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, SynonymProductStatusCB.class);
    }
    ...
    public HpSLCFunction<SynonymProductStatusCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, SynonymProductStatusCB.class);
    }
    ...
    public HpSLCFunction<SynonymProductStatusCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, SynonymProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymProductStatusCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, SynonymProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<SynonymProductStatusCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, SynonymProductStatusCB.class);
    }
