...
public class BsSynonymNextLinkSecretCQ extends AbstractBsSynonymNextLinkSecretCQ {
    ...
    public ConditionValue xdfgetSecretCode()
    ...
    public ConditionValue xdfgetSecretName()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, SynonymNextLinkSecretCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(SynonymNextLinkSecretCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, SynonymNextLinkSecretCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(SynonymNextLinkSecretCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, SynonymNextLinkSecretCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, SynonymNextLinkSecretCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(SynonymNextLinkSecretCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, SynonymNextLinkSecretCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
