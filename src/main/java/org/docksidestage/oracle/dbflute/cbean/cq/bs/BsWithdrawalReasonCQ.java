...
public class BsWithdrawalReasonCQ extends AbstractBsWithdrawalReasonCQ {
    ...
    public Map<String, SynonymMemberWithdrawalCQ> xdfgetWithdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList"); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> xdfgetWithdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList"); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> xdfgetWithdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList"); }
    ...
    public Map<String, SynonymMemberWithdrawalCQ> xdfgetWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList() { return xgetSQueMap("withdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList"); }
