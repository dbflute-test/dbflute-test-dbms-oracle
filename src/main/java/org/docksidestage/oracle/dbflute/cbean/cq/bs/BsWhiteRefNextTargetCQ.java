...
public class BsWhiteRefNextTargetCQ extends AbstractBsWhiteRefNextTargetCQ {
    ...
    public ConditionValue xdfgetRefNextTargetId()
    { if (_refNextTargetId == null) { _refNextTargetId = nCV(); }
      return _refNextTargetId; }
    protected ConditionValue xgetCValueRefNextTargetId() { return xdfgetRefNextTargetId(); }
    ...
    public ConditionValue xdfgetNextTargetCode()
    { if (_nextTargetCode == null) { _nextTargetCode = nCV(); }
      return _nextTargetCode; }
    protected ConditionValue xgetCValueNextTargetCode() { return xdfgetNextTargetCode(); }
    ...
    public NextSchemaProductStatusCQ queryNextSchemaProductStatus() {
        return xdfgetConditionQueryNextSchemaProductStatus();
    }
    public NextSchemaProductStatusCQ xdfgetConditionQueryNextSchemaProductStatus() {
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, WhiteRefNextTargetCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(WhiteRefNextTargetCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, WhiteRefNextTargetCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(WhiteRefNextTargetCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, WhiteRefNextTargetCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, WhiteRefNextTargetCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(WhiteRefNextTargetCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, WhiteRefNextTargetCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
