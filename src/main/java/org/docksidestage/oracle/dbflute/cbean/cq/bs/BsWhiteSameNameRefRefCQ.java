...
public class BsWhiteSameNameRefRefCQ extends AbstractBsWhiteSameNameRefRefCQ {
    ...
    public ConditionValue xdfgetRefRefId()
    ...
    public ConditionValue xdfgetRefRefName()
    ...
    public ConditionValue xdfgetRefRefDate()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, WhiteSameNameRefRefCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(WhiteSameNameRefRefCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, WhiteSameNameRefRefCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(WhiteSameNameRefRefCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, WhiteSameNameRefRefCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, WhiteSameNameRefRefCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(WhiteSameNameRefRefCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, WhiteSameNameRefRefCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
