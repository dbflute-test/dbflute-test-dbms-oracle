...
public class BsVendorSynonymMemberCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public VendorSynonymMemberCB acceptPK(Integer memberId) {
    ...
    public VendorSynonymMemberCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected VendorSynonymMemberCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<VendorSynonymMemberCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorSynonymMemberCB> unionCBLambda) {
        final VendorSynonymMemberCB cb = new VendorSynonymMemberCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">vendorSynonymMemberBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">vendorSynonymMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">vendorSynonymMember</span>.<span style="color: #CC4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">vendorSynonymMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">vendorSynonymMember</span>.<span style="color: #CC4747">getSynonymMemberWithdrawalAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorSynonymMemberCQ> {
         ...
         */
        public HpSDRFunction<SynonymMemberLoginCB, VendorSynonymMemberCQ> derivedSynonymMemberLogin() {
            assertDerived("synonymMemberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<SynonymMemberLoginCB> sq, VendorSynonymMemberCQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<VendorSynonymMemberCB, VendorSynonymMemberCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorSynonymMemberCB> sq, VendorSynonymMemberCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;VendorSynonymMemberCB&gt;() {
     ...
     */
    public HpColQyOperand<VendorSynonymMemberCB> columnQuery(final SpecifyQuery<VendorSynonymMemberCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;VendorSynonymMemberCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<VendorSynonymMemberCB> orCBLambda) {
        xorSQ((VendorSynonymMemberCB)this, orCBLambda);
    }
     ...
     *     public void query(VendorSynonymMemberCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorSynonymMemberCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorSynonymMemberCB> andCBLambda) {
        xorSQAP((VendorSynonymMemberCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return VendorSynonymMemberCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return VendorSynonymMemberCQ.class.getName(); }
