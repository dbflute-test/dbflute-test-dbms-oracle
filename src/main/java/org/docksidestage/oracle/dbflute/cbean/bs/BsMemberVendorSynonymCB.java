...
public class BsMemberVendorSynonymCB extends AbstractConditionBean {
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;MemberVendorSynonymCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;MemberVendorSynonymCB&gt;() {
     ...
     *     public void query(MemberVendorSynonymCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;MemberVendorSynonymCB&gt;() {
