...
public class BsSynonymExceptCQ extends AbstractBsSynonymExceptCQ {
    ...
    public Map<String, SynonymRefExceptCQ> xdfgetExceptId_ExistsReferrer_SynonymRefExceptList() { return xgetSQueMap("exceptId_ExistsReferrer_SynonymRefExceptList"); }
    ...
    public Map<String, SynonymRefExceptCQ> xdfgetExceptId_NotExistsReferrer_SynonymRefExceptList() { return xgetSQueMap("exceptId_NotExistsReferrer_SynonymRefExceptList"); }
    ...
    public Map<String, SynonymRefExceptCQ> xdfgetExceptId_SpecifyDerivedReferrer_SynonymRefExceptList() { return xgetSQueMap("exceptId_SpecifyDerivedReferrer_SynonymRefExceptList"); }
    ...
    public Map<String, SynonymRefExceptCQ> xdfgetExceptId_QueryDerivedReferrer_SynonymRefExceptList() { return xgetSQueMap("exceptId_QueryDerivedReferrer_SynonymRefExceptList"); }
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, SynonymExceptCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(SynonymExceptCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, SynonymExceptCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(SynonymExceptCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, SynonymExceptCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, SynonymExceptCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(SynonymExceptCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, SynonymExceptCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
