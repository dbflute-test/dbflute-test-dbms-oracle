...
public class BsSynonymMemberCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public SynonymMemberCB acceptPK(Integer memberId) {
    ...
    public SynonymMemberCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected SynonymMemberCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<SynonymMemberCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<SynonymMemberCB> unionCBLambda) {
        final SynonymMemberCB cb = new SynonymMemberCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">synonymMemberBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">synonymMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMember</span>.<span style="color: #CC4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">synonymMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMember</span>.<span style="color: #CC4747">getSynonymMemberWithdrawalAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<SynonymMemberCQ> {
         ...
         */
        public HpSDRFunction<SynonymMemberLoginCB, SynonymMemberCQ> derivedSynonymMemberLogin() {
            assertDerived("synonymMemberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<SynonymMemberLoginCB> sq, SynonymMemberCQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<SynonymMemberCB, SynonymMemberCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<SynonymMemberCB> sq, SynonymMemberCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;SynonymMemberCB&gt;() {
     ...
     */
    public HpColQyOperand<SynonymMemberCB> columnQuery(final SpecifyQuery<SynonymMemberCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;SynonymMemberCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<SynonymMemberCB> orCBLambda) {
        xorSQ((SynonymMemberCB)this, orCBLambda);
    }
     ...
     *     public void query(SynonymMemberCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;SynonymMemberCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<SynonymMemberCB> andCBLambda) {
        xorSQAP((SynonymMemberCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return SynonymMemberCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return SynonymMemberCQ.class.getName(); }
