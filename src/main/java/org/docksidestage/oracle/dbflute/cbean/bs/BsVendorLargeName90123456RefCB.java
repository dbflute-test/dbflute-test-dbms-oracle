...
public class BsVendorLargeName90123456RefCB extends AbstractConditionBean {
    ...
    public VendorLargeName90123456RefCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected VendorLargeName90123456RefCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<VendorLargeName90123456RefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorLargeName90123456RefCB> unionCBLambda) {
        final VendorLargeName90123456RefCB cb = new VendorLargeName90123456RefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">vendorLargeName90123456RefBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_VendorLargeName901234567890()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">vendorLargeName90123456Ref</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">vendorLargeName90123456Ref</span>.<span style="color: #CC4747">getVendorLargeName901234567890()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorLargeName90123456RefCQ> {
         ...
         */
        public SpecifiedColumn columnVendorLargeName90123RefId() { return doColumn("VENDOR_LARGE_NAME_90123_REF_ID"); }
        /**
         * VENDOR_LARGE_NAME_901_REF_NAME: {NotNull, VARCHAR2(32)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVendorLargeName901RefName() { return doColumn("VENDOR_LARGE_NAME_901_REF_NAME"); }
        /**
         * VENDOR_LARGE_NAME_901234567_ID: {NUMBER(16), FK to VENDOR_LARGE_NAME_901234567890}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVendorLargeName901234567Id() { return doColumn("VENDOR_LARGE_NAME_901234567_ID"); }
        ...
        public VendorLargeName901234567890CB.HpSpecification specifyVendorLargeName901234567890() {
            ...
            if (_vendorLargeName901234567890 == null) {
                _vendorLargeName901234567890 = new VendorLargeName901234567890CB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryVendorLargeName901234567890()
                                    , () -> _qyCall.qy().queryVendorLargeName901234567890())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _vendorLargeName901234567890.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryVendorLargeName901234567890()
                      , () -> xsyncQyCall().qy().queryVendorLargeName901234567890()));
                }
            }
        ...
        public HpSDRFunction<VendorLargeName90123456RefCB, VendorLargeName90123456RefCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorLargeName90123456RefCB> sq, VendorLargeName90123456RefCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;VendorLargeName90123456RefCB&gt;() {
     ...
     */
    public HpColQyOperand<VendorLargeName90123456RefCB> columnQuery(final SpecifyQuery<VendorLargeName90123456RefCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;VendorLargeName90123456RefCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<VendorLargeName90123456RefCB> orCBLambda) {
        xorSQ((VendorLargeName90123456RefCB)this, orCBLambda);
    }
     ...
     *     public void query(VendorLargeName90123456RefCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorLargeName90123456RefCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorLargeName90123456RefCB> andCBLambda) {
        xorSQAP((VendorLargeName90123456RefCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return VendorLargeName90123456RefCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return VendorLargeName90123456RefCQ.class.getName(); }
