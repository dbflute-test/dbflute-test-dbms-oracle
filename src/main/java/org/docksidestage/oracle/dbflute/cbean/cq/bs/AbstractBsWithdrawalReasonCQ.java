...
public abstract class AbstractBsWithdrawalReasonCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">existsSynonymMemberWithdrawal</span>(withdrawalCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     withdrawalCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of SynonymMemberWithdrawalList for 'exists'. (NotNull)
     */
    public void existsSynonymMemberWithdrawal(SubQuery<SynonymMemberWithdrawalCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        SynonymMemberWithdrawalCB cb = new SynonymMemberWithdrawalCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepWithdrawalReasonCode_ExistsReferrer_SynonymMemberWithdrawalList(cb.query());
     ...
     * SYNONYM_MEMBER_WITHDRAWAL by WITHDRAWAL_REASON_CODE, named 'synonymMemberWithdrawalAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsSynonymMemberWithdrawal</span>(withdrawalCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     withdrawalCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of WithdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList for 'not exists'. (NotNull)
     */
    public void notExistsSynonymMemberWithdrawal(SubQuery<SynonymMemberWithdrawalCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        SynonymMemberWithdrawalCB cb = new SynonymMemberWithdrawalCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepWithdrawalReasonCode_NotExistsReferrer_SynonymMemberWithdrawalList(cb.query());
    ...
    public void xsderiveSynonymMemberWithdrawalList(String fn, SubQuery<SynonymMemberWithdrawalCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepWithdrawalReasonCode_SpecifyDerivedReferrer_SynonymMemberWithdrawalList(cb.query());
     ...
     * SYNONYM_MEMBER_WITHDRAWAL by WITHDRAWAL_REASON_CODE, named 'synonymMemberWithdrawalAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedSynonymMemberWithdrawal()</span>.<span style="color: #CC4747">max</span>(withdrawalCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     withdrawalCB.specify().<span style="color: #CC4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *     withdrawalCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     * }).<span style="color: #CC4747">greaterEqual</span>(123); <span style="color: #3F7E5E">// condition to derived column</span>
     * </pre>
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<SynonymMemberWithdrawalCB> derivedSynonymMemberWithdrawal() {
    ...
    protected HpQDRFunction<SynonymMemberWithdrawalCB> xcreateQDRFunctionSynonymMemberWithdrawalList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveSynonymMemberWithdrawalList(fn, sq, rd, vl, op));
    }
    public void xqderiveSynonymMemberWithdrawalList(String fn, SubQuery<SynonymMemberWithdrawalCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        SynonymMemberWithdrawalCB cb = new SynonymMemberWithdrawalCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalList(cb.query()); String prpp = keepWithdrawalReasonCode_QueryDerivedReferrer_SynonymMemberWithdrawalListParameter(vl);
