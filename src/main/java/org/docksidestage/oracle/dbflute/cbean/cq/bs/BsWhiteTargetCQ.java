...
public class BsWhiteTargetCQ extends AbstractBsWhiteTargetCQ {
    ...
    public Map<String, WhiteRefTargetCQ> xdfgetTargetId_ExistsReferrer_WhiteRefTargetList() { return xgetSQueMap("targetId_ExistsReferrer_WhiteRefTargetList"); }
    ...
    public Map<String, WhiteRefTargetCQ> xdfgetTargetId_NotExistsReferrer_WhiteRefTargetList() { return xgetSQueMap("targetId_NotExistsReferrer_WhiteRefTargetList"); }
    ...
    public Map<String, WhiteRefTargetCQ> xdfgetTargetId_SpecifyDerivedReferrer_WhiteRefTargetList() { return xgetSQueMap("targetId_SpecifyDerivedReferrer_WhiteRefTargetList"); }
    ...
    public Map<String, WhiteRefTargetCQ> xdfgetTargetId_QueryDerivedReferrer_WhiteRefTargetList() { return xgetSQueMap("targetId_QueryDerivedReferrer_WhiteRefTargetList"); }
    ...
    public ConditionValue xdfgetTargetName()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, WhiteTargetCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(WhiteTargetCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, WhiteTargetCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(WhiteTargetCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, WhiteTargetCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, WhiteTargetCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(WhiteTargetCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, WhiteTargetCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
