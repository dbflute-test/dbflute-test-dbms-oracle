...
public class BsWhiteSameNameCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteSameNameCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteSameNameCB> unionCBLambda) {
        final WhiteSameNameCB cb = new WhiteSameNameCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSameNameCQ> {
        ...
        public HpSDRFunction<WhiteSameNameCB, WhiteSameNameCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteSameNameCB> sq, WhiteSameNameCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<WhiteSameNameCB> orCBLambda) {
        xorSQ((WhiteSameNameCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WhiteSameNameCB> andCBLambda) {
        xorSQAP((WhiteSameNameCB)this, andCBLambda);
    }
