...
public class BsSynonymProductStatusCQ extends AbstractBsSynonymProductStatusCQ {
    ...
    public Map<String, SynonymProductCQ> xdfgetProductStatusCode_ExistsReferrer_SynonymProductList() { return xgetSQueMap("productStatusCode_ExistsReferrer_SynonymProductList"); }
    ...
    public Map<String, SynonymProductCQ> xdfgetProductStatusCode_NotExistsReferrer_SynonymProductList() { return xgetSQueMap("productStatusCode_NotExistsReferrer_SynonymProductList"); }
    ...
    public Map<String, SynonymProductCQ> xdfgetProductStatusCode_SpecifyDerivedReferrer_SynonymProductList() { return xgetSQueMap("productStatusCode_SpecifyDerivedReferrer_SynonymProductList"); }
    ...
    public Map<String, SynonymProductCQ> xdfgetProductStatusCode_QueryDerivedReferrer_SynonymProductList() { return xgetSQueMap("productStatusCode_QueryDerivedReferrer_SynonymProductList"); }
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, SynonymProductStatusCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(SynonymProductStatusCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, SynonymProductStatusCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(SynonymProductStatusCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, SynonymProductStatusCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, SynonymProductStatusCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(SynonymProductStatusCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, SynonymProductStatusCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
