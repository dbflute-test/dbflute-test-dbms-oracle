...
public abstract class AbstractBsNextSchemaProductStatusCQ extends AbstractConditionQuery {
    ...
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, NextSchemaProductStatusCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, NextSchemaProductStatusCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, NextSchemaProductStatusCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, NextSchemaProductStatusCB.class);
    }
    ...
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, NextSchemaProductStatusCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NextSchemaProductStatusCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, NextSchemaProductStatusCB.class);
    }
