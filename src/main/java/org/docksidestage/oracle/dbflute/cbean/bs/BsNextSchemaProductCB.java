...
public class BsNextSchemaProductCB extends AbstractConditionBean {
     ...
     * <pre>
     * <span style="color: #0000C0">nextSchemaProductBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">nextSchemaProduct</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">nextSchemaProduct</span>.<span style="color: #CC4747">getNextSchemaProductStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     */
    public HpColQyOperand<NextSchemaProductCB> columnQuery(final SpecifyQuery<NextSchemaProductCB> colCBLambda) {
