...
public class BsNextSchemaProductStatusCB extends AbstractConditionBean {
    ...
    public NextSchemaProductStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected NextSchemaProductStatusCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<NextSchemaProductStatusCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<NextSchemaProductStatusCB> unionCBLambda) {
        final NextSchemaProductStatusCB cb = new NextSchemaProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextSchemaProductStatusCQ> {
         ...
         * }, WhiteRefNextTarget.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         ...
         * }, NextSchemaProduct.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;NextSchemaProductStatusCB&gt;() {
     ...
     */
    public HpColQyOperand<NextSchemaProductStatusCB> columnQuery(final SpecifyQuery<NextSchemaProductStatusCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;NextSchemaProductStatusCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<NextSchemaProductStatusCB> orCBLambda) {
        xorSQ((NextSchemaProductStatusCB)this, orCBLambda);
    }
     ...
     *     public void query(NextSchemaProductStatusCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;NextSchemaProductStatusCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NextSchemaProductStatusCB> andCBLambda) {
        xorSQAP((NextSchemaProductStatusCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return NextSchemaProductStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return NextSchemaProductStatusCQ.class.getName(); }
