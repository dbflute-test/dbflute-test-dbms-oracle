...
public class BsVendorLargeName901234567890CQ extends AbstractBsVendorLargeName901234567890CQ {
    ...
    public Map<String, VendorLargeName90123456RefCQ> xdfgetVendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefList() { return xgetSQueMap("vendorLargeName901234567Id_ExistsReferrer_VendorLargeName90123456RefList"); }
    ...
    public Map<String, VendorLargeName90123456RefCQ> xdfgetVendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefList() { return xgetSQueMap("vendorLargeName901234567Id_NotExistsReferrer_VendorLargeName90123456RefList"); }
    ...
    public Map<String, VendorLargeName90123456RefCQ> xdfgetVendorLargeName901234567Id_SpecifyDerivedReferrer_VendorLargeName90123456RefList() { return xgetSQueMap("vendorLargeName901234567Id_SpecifyDerivedReferrer_VendorLargeName90123456RefList"); }
    ...
    public Map<String, VendorLargeName90123456RefCQ> xdfgetVendorLargeName901234567Id_QueryDerivedReferrer_VendorLargeName90123456RefList() { return xgetSQueMap("vendorLargeName901234567Id_QueryDerivedReferrer_VendorLargeName90123456RefList"); }
    ...
    public ConditionValue xdfgetVendorLargeName9012345Name()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, VendorLargeName901234567890CQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(VendorLargeName901234567890CQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, VendorLargeName901234567890CQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(VendorLargeName901234567890CQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, VendorLargeName901234567890CQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, VendorLargeName901234567890CQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(VendorLargeName901234567890CQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, VendorLargeName901234567890CQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
