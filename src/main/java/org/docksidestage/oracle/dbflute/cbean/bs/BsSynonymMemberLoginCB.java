...
public class BsSynonymMemberLoginCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public SynonymMemberLoginCB acceptUniqueOf(Integer memberId, java.time.LocalDateTime loginDatetime) {
    ...
    public SynonymMemberLoginCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected SynonymMemberLoginCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<SynonymMemberLoginCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<SynonymMemberLoginCB> unionCBLambda) {
        final SynonymMemberLoginCB cb = new SynonymMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">synonymMemberLoginBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">synonymMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMemberLogin</span>.<span style="color: #CC4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">synonymMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMemberLogin</span>.<span style="color: #CC4747">getMemberVendorSynonym()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">synonymMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMemberLogin</span>.<span style="color: #CC4747">getSynonymMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">synonymMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">synonymMemberLogin</span>.<span style="color: #CC4747">getVendorSynonymMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<SynonymMemberLoginCQ> {
        ...
        public HpSDRFunction<SynonymMemberLoginCB, SynonymMemberLoginCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<SynonymMemberLoginCB> sq, SynonymMemberLoginCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;SynonymMemberLoginCB&gt;() {
     ...
     */
    public HpColQyOperand<SynonymMemberLoginCB> columnQuery(final SpecifyQuery<SynonymMemberLoginCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;SynonymMemberLoginCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<SynonymMemberLoginCB> orCBLambda) {
        xorSQ((SynonymMemberLoginCB)this, orCBLambda);
    }
     ...
     *     public void query(SynonymMemberLoginCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;SynonymMemberLoginCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<SynonymMemberLoginCB> andCBLambda) {
        xorSQAP((SynonymMemberLoginCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return SynonymMemberLoginCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return SynonymMemberLoginCQ.class.getName(); }
