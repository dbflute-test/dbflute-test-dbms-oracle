...
public class BsWhiteUqFkCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteUqFkCQ> {
         ...
         */
        public HpSDRFunction<WhiteUqFkRefCB, WhiteUqFkCQ> derivedWhiteUqFkRefByFkToPkId() {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WhiteUqFkRefCB, WhiteUqFkCQ> derivedWhiteUqFkRefByFkToUqCode() {
     ...
     */
    public HpColQyOperand<WhiteUqFkCB> columnQuery(final SpecifyQuery<WhiteUqFkCB> colCBLambda) {
