...
public class BsWhiteDiffWorldCQ extends AbstractBsWhiteDiffWorldCQ {
    ...
    public ConditionValue xdfgetDiffWorldId()
    ...
    public ConditionValue xdfgetDiffWorldName()
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, WhiteDiffWorldCQ> xdfgetScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(WhiteDiffWorldCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, WhiteDiffWorldCQ> xdfgetSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(WhiteDiffWorldCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, WhiteDiffWorldCQ> xdfgetQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    ...
    public Map<String, WhiteDiffWorldCQ> xdfgetMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(WhiteDiffWorldCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, WhiteDiffWorldCQ> xdfgetMyselfInScope() { return xgetSQueMap("myselfInScope"); }
